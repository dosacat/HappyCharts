function UserDB() {
    let users = [
        ...
        {id:5, name:"Sheela", designation:"Employee", team:"Marketing", manager:1},
        ...
        {id:12, name:"Charles", designation:"Associate", team:"Technology", manager:9},
        {id:13, name:"Delta", designation:"Associate", team:"Technology", manager:12},
        {id:14, name:"Farrow", designation:"Associate", team:"Marketing", manager:5},
        {id:15, name:"Sarah", designation:"Associate", team:"Management", manager:4},
        {id:16, name:"Cynthia", designation:"Associate", team:"Management", manager:17},
        {id:17, name:"Ravi", designation:"Associate", team:"Management", manager:4},
        {id:18, name:"Viraj", designation:"Associate", team:"HR", manager:3},
        ...
        {id:21, name:"Arjun", designation:"Associate", team:"Marketing", manager:19},
];
